          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="px-6 py-2.5 text-purple-700 font-medium rounded-full bg-purple-50 transition-all duration-200 hover:shadow-soft"
              >
                Playground
              </button>
              <button
                onClick={() => navigate('/profile')}
                className="px-6 py-2.5 text-gray-700 font-medium rounded-full bg-pink-50 transition-all duration-200"
              >
                Profile
              </button>
            </div>
